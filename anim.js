...
const lyricsData = [
  ...
  { start: 33.2, end: 36.0, text: "Fell from the sky", translation: "Cayó desde el cielo" },
  ...
  { start: 54.5, end: 59.2, text: "Too much light for twilight", translation: "Tanta luz para el atardecer" },
  ...
  { start: 80.0, end: 86.8, text: "Silence, let me see what it was", translation: "Silencio, déjame ver lo que fue" },
  ...
  { start: 108.0, end: 113.0, text: "Too much light for twilight", translation: "Tanta luz para el atardecer" },
  ...
  { start: 183.2, end: 188.5, text: "Too much light for twilight", translation: "Tanta luz para el atardecer" },
  { start: 189.0, end: 202.0, text: "In the mood for the flowers' love...", translation: "Completamente enamorado de ti..." }
];
